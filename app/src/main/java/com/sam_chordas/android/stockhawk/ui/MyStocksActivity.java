...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, StockDetailFragment.OnFragmentInteractionListener{
            ...
            new RecyclerViewItemClickListener.OnItemClickListener() {
              @Override public void onItemClick(View v, int position) {
                ...
                // do something on item click
                  ...
                  bundle.putString("symbol", tv.getText().toString());
                  stockDetailFragment.setArguments(bundle);
                  getSupportFragmentManager().beginTransaction().add(R.id.stock_frag_container,stockDetailFragment).commit();
              }
            }));
